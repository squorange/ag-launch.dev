...
// Google Maps Styling
    ...
    function init() {
				...
				/* Combined init() functions for Clear Default Text */
...
//          draggable : true,
            ...
            styles: [
				...
				var mapElement = document.getElementById('ag_map');
				        ...
				        var locations = [
									['Awaken Group', '51 Waterloo St. #03-06<br />Singapore 187969<br />', '+65 6337 6642', '', 'undefined', 1.2980448153109914, 103.85142729881136, 'http://awakengroup.com/resources/icon-map-pin.png'],['NTUC Carpark', 'Enter from Queen St.', 'undefined', 'undefined', 'undefined', 1.2968434912953895, 103.8514464318771, 'http://awakengroup.com/resources/icon-map-p.png']
				        ];
